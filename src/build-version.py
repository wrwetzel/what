...
"""
    ...
    <tr>
        <td>Windows</td>
        <td><a href=/Downloads/what_win_installer_<***>.exe download>https://what/Downloads/what_win_installer_<***>.exe</a><br></td>
        <td><a href="javascript:void(0);" onclick="show_md( '/ReadMe-Windows.md' )" >ReadMe-Windows</a></td>
    </tr>

    <tr>
        <td>macOS</td>
        <td><a href=/Downloads/what-MacOS-<***>.dmg download>https://what/Downloads/what-MacOS-<***>.dmg</a><br></td>
        <td><a href="javascript:void(0);" onclick="show_md( '/ReadMe-macOS.md' )" >ReadMe-macOS</a></td>
    </tr>
    <tr>
        <td>Linux Zip</td>
        <td><a href=/Downloads/what-Linux-<***>.zip download>https://what/Downloads/what-Linux-<***>.zip</a><br></td>
        <td><a href="javascript:void(0);" onclick="show_md( '/ReadMe-Linux.md' )" >ReadMe-Linux</a></td>
    </tr>
    <tr>
        <td>Linux Gzip</td>
        <td><a href=/Downloads/what-Linux-<***>.gz download>https://what/Downloads/what-Linux-<***>.gz</a><br></td>
        <td><a href="javascript:void(0);" onclick="show_md( '/ReadMe-Linux.md' )" >ReadMe-Linux</a></td>
    </tr>
    """
