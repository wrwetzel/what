...
#   pyinstaller birdland-qt.spec --distpath ~/Uploads/pyinstaller
#   time pyinstaller birdland_qt.spec --clean --distpath ~/Uploads/pyinstaller/ --workpath ~/Uploads/pyinstaller/build
