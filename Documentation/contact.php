...
require_once( "/home/wrw/PHP/what.php" );
...
$mail->Username = $what_Username;                 // SMTP username
$mail->Password = $what_Password;                 // SMTP password
$mail->SMTPSecure = 'tls';                            // Enable TLS encryption, `ssl` also accepted
$mail->Port = 587;                                    // TCP port to connect to

$mail->setFrom( $email_from, 'What? User');
$mail->addAddress( $what_addAddress, 'What? Admin');     // Add a recipient
